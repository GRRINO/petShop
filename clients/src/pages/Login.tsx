import { BoxIcon, LockOpenIcon } from "lucide-react";
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className=" bg-[#FFF5E1] py-8 min-h-screen flex items-center justify-center ">
        <div className="bg-white relative mt-8 p-8 rounded-2xl shadow-lg max-w-md w-full">
          ...
          <div className="mb-6">
            <label className="flex items-center justify-center cursor-pointer">
              <div className="mr-3 text-[#8A9B6E] font-medium text-2xl">
                Login
              </div>
